...
class Assembly {
    ...
    static multiply(buffers, values) {
    ...
    static bars(buffers, values, options = { "y.scale.domain": [0, 1], "y.scale.type": "linear", "y.scale.base": 10 }) {
        ...
        return (0, vega_extractor_1.default)(spec);
    }
    static punchcard(buffers, names, values, options = { "z.scale.domain": [0, 1], "z.scale.type": "linear", "z.scale.base": 10, factor: 8 }) {
        ...
        let colors = buffers.map(b => (b.color1 || color_1.default.Blue).css());
    ...
    static hatch(tile, buffers, dataValues, options) {
        ...
        sorted.forEach(d => {
            ...
            if ((0, util_1.isUndefined)(options.widthprop))
